...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
                    ...
                    <form method="POST" action="{{ route('receta.update',['receta'=>$receta->id]) }}" enctype="multipart/form-data">
                        @csrf
@method('PUT')
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="titulo" type="text" class="form-control @error('titulo') is-invalid @enderror" name="titulo" value="{{ $receta->titulo }}" placeholder="Titulo receta"  autocomplete="titulo" autofocus>
...
<option value="{{$categorias->id  }}"{{ $receta->categoria_id == $categorias->id ? 'selected' :''}}>{{$categorias->titulo}}</option>
@endforeach
</select>
